// Monetization & Subscription Engine — AIBLTY Code
...
export const PLANS: Record<Plan, PlanConfig> = {
  ...
  starter: {
    ...
    price_monthly: 9.99,
    price_annual: 7.99,
    sku_monthly: 'com.sianlk.aibltycode.starter.monthly',
    sku_annual: 'com.sianlk.aibltycode.starter.annual',
    features: [
      '100 AI requests/day',
  ...
  pro: {
    ...
    price_monthly: 29.99,
    price_annual: 19.99,
    sku_monthly: 'com.sianlk.aibltycode.pro.monthly',
    sku_annual: 'com.sianlk.aibltycode.pro.annual',
    features: [
  ...
  enterprise: {
    ...
    price_monthly: 99.99,
    price_annual: 79.99,
    sku_monthly: 'com.sianlk.aibltycode.enterprise.monthly',
    sku_annual: 'com.sianlk.aibltycode.enterprise.annual',
    features: [
