...
const styles = StyleSheet.create({
  ...
  variant_secondary: { backgroundColor: '#818CF833' },
  variant_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#6366F1' },
  variant_ghost:     { backgroundColor: 'transparent' },
  variant_danger:    { backgroundColor: Colors.error },
  variant_ai:        { backgroundColor: '#4F46E5', borderWidth: 1, borderColor: '#818CF8' },

  // Labels
  label: { ...Typography.button },
  label_primary:   { color: '#FFFFFF' },
  label_secondary: { color: '#4F46E5' },
