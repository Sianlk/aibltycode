...
const s = StyleSheet.create({
  ...
  v_secondary: { backgroundColor: '#818CF833' },
  v_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#6366F1' },
  v_ghost:     { backgroundColor: 'transparent' },
  v_danger:    { backgroundColor: '#EF4444' },
  v_ai:        { backgroundColor: '#4F46E5', borderWidth: 1, borderColor: '#818CF8' },
  lbl:    { fontSize: 14, fontWeight: '600' },
  lv_primary:   { color: '#FFFFFF' },
  lv_secondary: { color: '#4F46E5' },
  lv_outline:   { color: '#6366F1' },
  lv_ghost:     { color: '#6366F1' },
