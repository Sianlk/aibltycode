...
const moduleLessons: Record<string, { id: string; title: string; description: string; icon: string; xpReward: number }[]> = {
  ...
  "systems-analysis": [
    ...
    { id: "class-diagrams", title: "UML Class Diagrams", description: "Object structures", icon: "🏛️", xpReward: 150 },
    { id: "sdlc-overview", title: "SDLC Overview", description: "Development lifecycle", icon: "🔄", xpReward: 100 },
    { id: "waterfall-model", title: "Waterfall Model", description: "Sequential development", icon: "🌊", xpReward: 100 },
    { id: "agile-methods", title: "Agile & Scrum", description: "Iterative approach", icon: "🏃", xpReward: 125 },
    { id: "security-basics", title: "Security Basics", description: "CIA triad & auth", icon: "🔐", xpReward: 100 },
    { id: "risk-management", title: "Risk Management", description: "Identify & mitigate", icon: "🛡️", xpReward: 100 },
    { id: "compliance", title: "GDPR & Compliance", description: "Data protection", icon: "📜", xpReward: 100 },
  ...
  "math-computing": [
    ...
    { id: "binary-arithmetic", title: "Binary Arithmetic", description: "Add & subtract binary", icon: "➕", xpReward: 100 },
    ...
    { id: "sets-basics", title: "Sets & Operations", description: "Union, intersection", icon: "⭕", xpReward: 100 },
    { id: "set-laws", title: "Set Laws", description: "De Morgan's laws", icon: "📐", xpReward: 125 },
    { id: "probability-basics", title: "Probability Basics", description: "Chance calculation", icon: "🎲", xpReward: 100 },
    { id: "conditional-prob", title: "Conditional Probability", description: "P(A|B) events", icon: "🔮", xpReward: 125 },
    { id: "patterns-sequences", title: "Patterns & Sequences", description: "Arithmetic, geometric", icon: "📈", xpReward: 100 },
    { id: "graphs-basics", title: "Graph Theory Basics", description: "Nodes and edges", icon: "🌳", xpReward: 125 },
    { id: "tree-structures", title: "Tree Structures", description: "Binary trees, traversal", icon: "🌲", xpReward: 150 },
    { id: "complexity-intro", title: "Big-O Introduction", description: "Time complexity", icon: "⏱️", xpReward: 125 },
    { id: "complexity-analysis", title: "Complexity Analysis", description: "O(1), O(n), O(n²)", icon: "📊", xpReward: 150 },
    { id: "functions-relations", title: "Functions & Relations", description: "Mappings", icon: "🔗", xpReward: 100 },
  ],
};
