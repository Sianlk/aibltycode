...
const moduleLessons: Record<string, { id: string; title: string; description: string; icon: string; xpReward: number }[]> = {
  ...
  "systems-analysis": [
    ...
    { id: "process-modelling", title: "Process Modelling", description: "DFDs and BPMN", icon: "📊", xpReward: 125 },
    ...
    { id: "testing", title: "Testing Strategies", description: "Unit, integration, UAT", icon: "🧪", xpReward: 125 },
  ],
