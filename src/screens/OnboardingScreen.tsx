...
const SLIDES = [{"emoji": "\ud83d\ude80", "title": "AIBLTY Code", "body": "Write Less. Build More."}, {"emoji": "\ud83d\udd12", "title": "Bank-Grade Security", "body": "Your data is protected with end-to-end encryption and MFA."}, {"emoji": "\u26a1", "title": "Built for Speed", "body": "Real-time AI processing with sub-second response times."}];
