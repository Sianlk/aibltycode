    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.header}>
          ...
          <Text style={styles.tagline}>Write Less. Build More.</Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Quick Access</Text>
        <View key="0" style={styles.featureCard}>
          <Text style={styles.featureText}>AI Code Generation</Text>
        </View>
        <View key="1" style={styles.featureCard}>
          <Text style={styles.featureText}>Smart Autocomplete</Text>
        </View>
        <View key="2" style={styles.featureCard}>
          <Text style={styles.featureText}>Code Review</Text>
        </View>
        <View key="3" style={styles.featureCard}>
          <Text style={styles.featureText}>Project Templates</Text>
        </View>
        </View>
        {user && (
