  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <SettingRow label='Subscription' value='Manage' action={() => open('https://aiblty-code.sianlk.com/subscription')} />
        <SettingRow label='Change Password' action={() => {}} />
        <SettingRow label='Two-Factor Authentication' action={() => {}} />
        <Text style={styles.sectionHeader}>SUPPORT</Text>
        <SettingRow label='Help Centre' action={() => open('https://aiblty-code.sianlk.com/support')} />
        <SettingRow label='Privacy Policy' action={() => open('https://aiblty-code.sianlk.com/privacy')} />
        <SettingRow label='Terms of Service' action={() => open('https://aiblty-code.sianlk.com/terms')} />
